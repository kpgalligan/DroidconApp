...
public interface UpdateUserProfile
{
    ...
    Response update(@Field("name") String name, @Field("profile") String profile, @Field("company") String company, @Field("twitter") String twitter, @Field("linkedIn") String linkedIn, @Field("website") String website, @Field("phoneticName") String phoneticName, @Field("nickname") String nickname, @Field("phone") String phone, @Field("email") String email, @Field("gPlus") String gPlus, @Field("facebook") String facebook, @Field("emailPublic") Boolean emailPublic);
}
